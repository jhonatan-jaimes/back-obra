...
public class Tipo {
    ...
    public Tipo(Long id, String nameTipo, Integer cantidad, Medidas medidas, Areas areas, Materiales material, Elementos elemento) {
        this.id = id;
    ...
    public void setMateriales(Materiales material) {
        this.material = material;
    }
