...
public class Tipo2dConcretoInDTO {
    ...
    public Tipo2dConcretoInDTO() {
    }

    public Tipo2dConcretoInDTO(Long id, String nameElemento, String nameMaterial, String nameTipo, Integer cantidad, Double largo, Double ancho, Double areaUnidad, Double areaTotal, String psi, Double cementoUnidad, Double arenaUnidad, Double gravaUnidad, Double aguaUnidad, Double cementoTotal, Double arenaTotal, Double gravaTotal, Double aguaTotal) {
        this.id = id;
